...
static std::string TempInsanity[11]{
	...
	"躁狂：调查员由于某种诱因进入躁狂状态，症状持续{0}轮。\n{1}\n具体躁狂症: {2}(KP也可以自行从躁狂症状表中选择其他症状)"
};
...
static std::string LongInsanity[11]{
	...
	"躁狂：调查员患上一个新的躁狂症，在{0}小时后恢复理智。在这次疯狂发作中，调查员将完全沉浸于其新的躁狂症状。这是否会被其他人理解（apparent to other people）则取决于守秘人和此调查员。\n{1}\n具体躁狂症: {2}(KP也可以自行从躁狂症状表中选择其他症状)"
};
