...
{"9mm 鲁格 P08","1D10"},
{".41(10.4mm) 左轮手枪","1D10"},
{".44(11.2mm) 马格南左轮手枪","1D10+1D4+2"},
{".45(11.43mm) 左轮手枪","1D10+2"},
{".45(11.43mm) 自动手枪","1D10+2"},
{"沙漠之鹰","1D10+1D6+3"},
{".58 (14.7mm)1855 年式春田步枪","1D10+4"},
{".22 (5.6mm)栓式枪机步枪","1D6+1"},
{".30 (7.62mm)杠杆式枪机步枪","2D6"},
{".45 马提尼·亨利步枪","1D8+1D6+3"},
{"莫兰上校的气动步枪","2D6+1"},
{"加兰德M1、M2步枪","2D6+4"},
{"SKS 半自动步枪(56 半)","2D6+1"},
{".303 (7.7mm) 李·恩菲尔德","2D6+4"},
{".30——06 (7.62mm) 栓式枪机步枪","2D6+4"},
{".30——06 (7.62mm) 半自动步枪","2D6+4"},
{".444 (11.28mm) 马林步枪","2D8+4"},
{"猎象枪(双管)","3D6+4"},
{"20 号霰弹枪(双管)","2D6"},
{"16 号霰弹枪(双管)","2D6+2"},
{"12 号霰弹枪(双管)","4D6"},
...
{"乌兹微型冲锋枪","1D10"},
{"1882 年式加特林","2D6+4"},
{"M1918 式勃朗宁自动步枪","2D6+4"},
{"勃朗宁 M1917A1(7.62mm)","2D6+4"},
{"布伦轻机枪","2D6+4"},
{"路易斯Ⅰ型机枪","2D6+4"},
{"GE M134 式 7.62mm 速射机枪","2D6+4"},
{"FN 米尼米(5.56mm)，弹夹/弹带","2D6"},
{"维克斯.303 机枪","2D6+4"},
{"莫洛托夫燃烧瓶","2D6"},
{"信号枪(信号弹枪)","1D10+1D3"},
{"M79 40mm 榴弹发射器","3D10"},
