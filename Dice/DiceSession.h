...
class DiceSession {
	...
	DiceSession& create(time_t tt) { tCreate = tt;	return *this; }
	DiceSession& update(time_t tt) { tUpdate = tt; save();	return *this; }
	DiceSession& update() { tUpdate = time(NULL);	return *this; }
