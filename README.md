...
Dice!分为**标准版**与**增强版**, 标准版已经几乎可以满足所有跑团所需，拓展版主要为想要把自己骰子公开的master们准备，其中包含了黑名单等管理功能。其中，标准版位于master分支，主要由溯洄负责，增强版位于Shiki分支，主要由空弦没羽负责。出现问题时，请确定使用的版本并向对应负责人报告(或者直接提issue)。增强版中可能还包含一些其他新功能，如果合适就会引入到标准版中。标准版更新频率较慢但增强版较快。在发布页面，不带Express字样的属于标准版，否则属于增强版。

## 开发者

贡献者:w4123溯洄 jh123111 緋色月下、スイカを食う 空弦没羽 等
